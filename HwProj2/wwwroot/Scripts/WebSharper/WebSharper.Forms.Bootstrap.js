...
{
 "use strict";
 var Global,WebSharper,Forms,Bootstrap,Controls,Simple,SC$1,List,Doc,UI,Doc$1,Seq,IntelliFactory,Runtime,View,View$1,AttrModule;
 Global=window;
 ...
 Controls.ShowErrors=function(extras,submit)
 {
  ...
  {
   return a.$==0?Doc$1.Empty():Doc$1.Element("div",extras,[Doc$1.Element("div",List.ofArray([(Controls.cls())("alert alert-danger")]),Seq.map(function(m)
   {
  ...
  })),List.ofSeq(Seq.delay(function()
  {
   return Seq.append([Doc$1.Element("label",labelExtras,[Doc$1.TextNode(lbl)])],Seq.delay(function()
   {
    ...
    }),target)],Seq.delay(function()
    {
     ...
     {
      return a!=null&&a.$==1?Doc$1.Element("span",[(Controls.cls())("help-block")],[Doc$1.TextNode(a.$0)]):Doc$1.Empty();
     },errorOpt)];
    }));
   }));
  })));
